...
public class Newsfeed implements Parcelable {
    ...
    protected Newsfeed(Parcel in) {
        photos_msize = in.createTypedArrayList(PhotoAttachment.CREATOR);
        photos_hsize = in.createTypedArrayList(PhotoAttachment.CREATOR);
        photos_osize = in.createTypedArrayList(PhotoAttachment.CREATOR);
        next_from = in.readLong();
    }
