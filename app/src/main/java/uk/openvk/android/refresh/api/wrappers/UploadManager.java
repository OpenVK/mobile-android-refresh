...
import uk.openvk.android.refresh.api.TrackingRequestBody;
...
public class UploadManager {
    ...
    public UploadManager(Context ctx, boolean use_https, Handler handler) {
                    ...
                    httpClient = new OkHttpClient.Builder()
                            ...
                            .proxy(new Proxy(Proxy.Type.HTTP,
                                    new InetSocketAddress(address_array[0],
                                            Integer.parseInt(address_array[1]))))
                            .build();
                }
            }
        } catch (Exception ex) {
